...
clip_model, preprocess = clip.load("pretrain/RN101.pkl")
...
with open('out/rn_alpha_vec_711.pkl', 'wb') as file:
...
for epoch in range(500):
    ...
    if acc_val > best_acc:
        best_acc = acc_val
        if best_acc > 0.72:
            classifier.save(f'out/LP-711-RN-{best_acc:.3f}.pkl')
    
    
state_dict = jt.load(f'out/LP-711-RN-{best_acc:.3f}.pkl')
